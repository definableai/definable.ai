...
description: Verified examples for accuracy, performance, reliability, and judge-based evaluations.
icon: chart-bar
---
...
| Script | Covers |
| --- | --- |
| `python examples/docs/evaluation_basics.py` | Accuracy, reliability, performance, and agent-as-judge flows |

## Tested evaluation surface
