...
Note: This file provides the same coverage as test_in_memory_vectordb.py
      but is organized as a migration target from tests_e2e/integration/.
      Tests that are already covered in test_in_memory_vectordb.py are
...
@pytest.mark.openai
class TestInMemoryVectorDBIntegration:
  """
