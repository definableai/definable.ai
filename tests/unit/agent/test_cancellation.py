...
Tests the token lifecycle: default state, cancel(), is_cancelled property,
and raise_if_cancelled() exception. No API calls.

Migrated from tests_e2e/unit/test_cancellation_token.py -- all original tests preserved.
"""
