"""
Behavioral tests: BrowserToolkit + MockModel dispatch (Playwright CDP version).

Migrated from: tests_e2e/behavioral/test_browser_agent.py

No real browser launched, no Playwright API calls.
...
_EXPECTED_TOOLS = 55  # See toolkit.py _make_tools for the full list


# ---------------------------------------------------------------------------
# Mock browser (no Playwright dependency)
# ---------------------------------------------------------------------------
...
class _MockBrowser(BaseBrowser):
  ...
  async def get_text(self, ref_or_selector: str = "body") -> str:
    return self._record("get_text", ref_or_selector)

  async def get_attribute(self, ref_or_selector: str, attribute: str) -> str:
    return self._record("get_attribute", ref_or_selector, attribute)

  async def is_element_visible(self, ref_or_selector: str) -> str:
    return self._record("is_element_visible", ref_or_selector)

  # -- Interaction --
  async def click(self, ref_or_selector: str) -> str:
    return self._record("click", ref_or_selector)

  async def click_if_visible(self, ref_or_selector: str) -> str:
    return self._record("click_if_visible", ref_or_selector)
  ...
  async def highlight(self, ref_or_selector: str) -> str:
    return self._record("highlight", ref_or_selector)
  ...
  async def scroll_to_element(self, ref_or_selector: str) -> str:
    return self._record("scroll_to_element", ref_or_selector)
  ...
  async def wait_for_element(self, ref_or_selector: str, timeout: float = 10.0) -> str:
    return self._record("wait_for_element", ref_or_selector, timeout)
  ...
  async def get_storage(self, key: str | None = None, kind: str = "local") -> str:
    return self._record("get_storage", key, kind)

  async def set_storage(self, key: str, value: str, kind: str = "local") -> str:
    return self._record("set_storage", key, value, kind)
  ...
  async def get_console(self, limit: int = 50, level: str | None = None) -> str:
    return self._record("get_console", limit, level)

  async def get_errors(self, limit: int = 20) -> str:
    return self._record("get_errors", limit)

  async def get_network(self, limit: int = 50, url_filter: str | None = None) -> str:
    return self._record("get_network", limit, url_filter)
...
class TestBrowserToolDispatch:
  ...
  async def test_click_dispatched(self, toolkit, mock_browser):
    ...
    result = await fn.entrypoint(ref_or_selector="#btn")
  ...
  async def test_type_dispatched(self, toolkit, mock_browser):
    ...
    result = await fn.entrypoint(ref_or_selector="#q", text="hello")
  ...
  async def test_get_text_dispatched(self, toolkit, mock_browser):
    ...
    result = await fn.entrypoint(ref_or_selector="h1")
  ...
  async def test_get_attribute_dispatched(self, toolkit, mock_browser):
    ...
    result = await fn.entrypoint(ref_or_selector="a", attribute="href")
  ...
  async def test_press_keys_dispatched(self, toolkit, mock_browser):
    ...
    result = await fn.entrypoint(ref_or_selector="#q", keys="\n")
  ...
  async def test_hover_dispatched(self, toolkit, mock_browser):
    ...
    result = await fn.entrypoint(ref_or_selector="#menu")
  ...
  async def test_drag_dispatched(self, toolkit, mock_browser):
    ...
    result = await fn.entrypoint(from_ref="#item", to_ref="#target")
  ...
  async def test_select_option_dispatched(self, toolkit, mock_browser):
    ...
    result = await fn.entrypoint(ref_or_selector="#country", text="Canada")
  ...
  async def test_is_checked_dispatched(self, toolkit, mock_browser):
    ...
    result = await fn.entrypoint(ref_or_selector="#agree")
  ...
  async def test_uncheck_dispatched(self, toolkit, mock_browser):
    ...
    result = await fn.entrypoint(ref_or_selector="#newsletter")
  ...
  async def test_set_value_dispatched(self, toolkit, mock_browser):
    ...
    result = await fn.entrypoint(ref_or_selector="#volume", value="75")
  ...
  async def test_fill_form_dispatched(self, toolkit, mock_browser):
    fn = next(t for t in toolkit.tools if t.name == "browser_fill_form")
    fields = [{"ref": "e1", "type": "text", "value": "hello"}]
    result = await fn.entrypoint(fields=fields)
    assert result == "ok:fill_form"

  async def test_get_console_dispatched(self, toolkit, mock_browser):
    fn = next(t for t in toolkit.tools if t.name == "browser_get_console")
    result = await fn.entrypoint(limit=10)
    assert result == "ok:get_console"

  async def test_get_errors_dispatched(self, toolkit, mock_browser):
    fn = next(t for t in toolkit.tools if t.name == "browser_get_errors")
    result = await fn.entrypoint(limit=5)
    assert result == "ok:get_errors"

  async def test_get_network_dispatched(self, toolkit, mock_browser):
    fn = next(t for t in toolkit.tools if t.name == "browser_get_network")
    result = await fn.entrypoint(limit=10, url_filter="/api/")
    assert result == "ok:get_network"
