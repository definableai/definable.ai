...
```bash
pip install 'definable-ai[postgres-memory]'   # asyncpg
pip install 'definable-ai[redis-memory]'       # redis
pip install 'definable-ai[qdrant-memory]'      # qdrant-client
pip install 'definable-ai[chroma-memory]'      # chromadb
pip install 'definable-ai[mongodb-memory]'     # motor
pip install 'definable-ai[pinecone-memory]'    # pinecone
```
