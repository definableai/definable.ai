...
agent = Agent(
    model="gpt-4o-mini",
    knowledge="./docs/",  # Auto-loads all files, sets up embedder + vector DB
...
These optional parameters enable advanced retrieval strategies. See [Hybrid Search & Scoring](/knowledge/hybrid-search) for full documentation.
