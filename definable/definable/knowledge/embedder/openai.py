...
class OpenAIEmbedder(Embedder):
  ...
  dimensions: Optional[int] = None  # type: ignore[assignment]
  ...
  async def async_get_embeddings_batch_and_usage(self, texts: List[str]) -> Tuple[List[List[float]], List[Optional[Dict]]]:
    """
