...
from definable.utils.vectordb import Distance, SearchType
...
class Qdrant(VectorDb):
    ...
    if self.search_type in [SearchType.vector, SearchType.hybrid]:
      if self.embedder.enable_batch and hasattr(self.embedder, "async_get_embeddings_batch_and_usage"):
        ...
        try:
          ...
          is_rate_limit = any(phrase in error_str for phrase in ["rate limit", "too many requests", "429", "trial key", "api calls / minute"])
  ...
  def point_exists(self, id: str) -> bool:  # noqa: A002
    ...
    try:
      ...
      points = self.client.retrieve(collection_name=self.collection, ids=[id], with_payload=False, with_vectors=False)
  ...
  def update_metadata(self, content_id: str, metadata: Dict[str, Any]) -> None:
    ...
    try:
      ...
      for point in points:
        ...
        # Update payload immediately; passing a concrete list avoids Optional typing
        # from models.SetPayload.points in static type checking.
      ...
      log_debug(f"Updated metadata for {len(points)} documents with content_id: {content_id}")
