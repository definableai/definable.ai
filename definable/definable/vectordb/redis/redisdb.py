...
from definable.utils.string import hash_string_sha256
...
class RedisDB(VectorDB):
  ...
  def delete_by_id(self, doc_id: str) -> bool:
    ...
    try:
      ...
      result = self.index.drop_documents(doc_id)
      log_debug(f"Deleted document with id '{doc_id}' from Redis index")
      return result > 0
    except Exception as e:
