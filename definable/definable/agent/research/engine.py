...
from definable.agent.research.models import ResearchMetrics, ResearchResult
from definable.agent.research.prompts import NEEDS_RESEARCH_PROMPT
...
if TYPE_CHECKING:
  ...
  from definable.agent.research.search.base import SearchProvider
...
class DeepResearch:
  ...
  async def arun(
    ...
    *,
    ...
    """
    from definable.agent.research import compressor, gap_analyzer, planner, reader, synthesizer
