...
from definable.tools.function import Function, get_entrypoint_docstring
...
def tool(*args, **kwargs) -> Union[Function, Callable[[F], Function]]:
  ...
  def decorator(func: F) -> Function:
    ...
    tool_config = {
      ...
      "description": kwargs.get("description", get_entrypoint_docstring(wrapper)),  # Get docstring if description not provided
