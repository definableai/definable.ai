...
from definable.models.response import ToolExecution, UserInputField
...
class RunRequirement:
  ...
  def to_dict(self) -> Dict[str, Any]:
    ...
    if self.tool_execution is not None:
      _dict["tool_execution"] = self.tool_execution.to_dict() if isinstance(self.tool_execution, ToolExecution) else self.tool_execution
  ...
  def from_dict(cls, data: Dict[str, Any]) -> "RunRequirement":
    ...
    if schema_raw is not None:
      ...
      requirement.user_input_schema = rebuilt_schema or None
