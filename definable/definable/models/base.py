...
from definable.models.response import ModelResponse, ModelResponseEvent, ToolExecution
...
from definable.tools.function import Function, FunctionCall, FunctionExecutionResult, UserInputField
...
class Model(ABC):
  ...
  def run_function_call(
    ...
    if isinstance(function_execution_result.result, (GeneratorType, collections.abc.Iterator)):
      ...
      from definable.tools.function import ToolResult
