...
|-------|-------------|---------------|---------|------------|
| `OpenAIChat` | `definable.models.openai` | `gpt-4o` | `OPENAI_API_KEY` | `Model` |
| `OpenAILike` | `definable.models.openai` | — | — | `OpenAIChat` |
| `DeepSeekChat` | `definable.models.deepseek` | `deepseek-chat` | `DEEPSEEK_API_KEY` | `OpenAILike` |
| `MoonshotChat` | `definable.models.moonshot` | `kimi-k2-turbo-preview` | `MOONSHOT_API_KEY` | `OpenAILike` |
| `xAI` | `definable.models.xai` | `grok-beta` | `XAI_API_KEY` | `OpenAILike` |
...
```python
from definable.models.pricing import ModelPricing, get_pricing, calculate_cost
```
